    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section("Seats") {
                    Text("Names and colors are set on the setup screen and remembered for next time. Once players have names, drag the seats into the order people are sitting.")
